use river::nn::layer_norm;
use river::nn::{Module, OptimizerConfig};
use river::{kind, nn, Device, Kind, Reduction, Tensor};
...
#[test]
fn bn_test() {
    let opts = (river::Kind::Float, river::Device::Cpu);
    let vs = nn::VarStore::new(river::Device::Cpu);
